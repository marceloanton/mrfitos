...
$router->add('GET', '/pos/member-account/autosettle-kpi/export', [PosController::class, 'autosettleKpiExport'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.report.export')]);
...
$router->add('GET', '/pos/member-account/contact-effectiveness', [PosController::class, 'memberAccountContactEffectivenessRange'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.report.read')]);
$router->add('GET', '/pos/member-account/contact-effectiveness/export', [PosController::class, 'memberAccountContactEffectivenessRangeExport'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.report.export')]);
$router->add('GET', '/pos/member-account/collector-ranking', [PosController::class, 'memberAccountCollectorRanking'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.report.read')]);
$router->add('GET', '/pos/member-account/collector-ranking/export', [PosController::class, 'memberAccountCollectorRankingExport'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.report.export')]);
...
$router->add('POST', '/pos/member-account/promise-agenda/bulk-contacted', [PosController::class, 'memberAccountPromiseAgendaBulkContacted'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('pos.sale.create')]);
$router->add('GET', '/pos/member-account/promise-agenda/overdue-whatsapp-links', [PosController::class, 'memberAccountPromiseAgendaOverdueWhatsAppLinks'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('whatsapp.send')]);
