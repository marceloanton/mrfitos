...
$router->add('POST', '/pos/sales/{id}/void', [PosController::class, 'voidSale'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.write')]);
...
$router->add('POST', '/pos/member-account/charges/{id}/settle', [PosController::class, 'settleMemberAccountCharge'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.write')]);
$router->add('GET', '/pos/stock/movements', [PosController::class, 'stockMovements'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.read')]);
$router->add('POST', '/pos/stock/adjust', [PosController::class, 'adjustStock'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.write')]);
$router->add('POST', '/pos/cash-sessions/open', [PosController::class, 'openCashSession'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.write')]);
$router->add('GET', '/pos/cash-sessions/open-summary', [PosController::class, 'openCashSessionSummary'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.read')]);
...
$router->add('GET', '/pos/reports/z-close/export', [PosController::class, 'zCloseReportExport'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.read')]);
$router->add('GET', '/pos/reports/cash-by-operator', [PosController::class, 'cashByOperatorReport'], [AuthMiddleware::class, TenantMiddleware::class, new PermissionMiddleware('payments.read')]);
