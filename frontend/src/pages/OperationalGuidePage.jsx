  ...
  return (
    <section className="space-y-6 print:space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-3 print:grid-cols-1">
        <article className="rounded-xl bg-white p-4 shadow-sm print:shadow-none print:border print:border-slate-300">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm print:shadow-none print:border print:border-slate-300">
